...
function authenticationStrategyCallback(req, res, next) {
    ...
    return (err, user, info) => {
        ...
        if (user) {
            ...
            redisEnt.getNormalFunRedis(RedisKeys.USER_AUTH_CHECK + user._id, async (err, userAuthData) => {
                // redis.getRedisLogin(RedisKeys.USER_AUTH_CHECK + user._id, (err, userAuthData) => {
