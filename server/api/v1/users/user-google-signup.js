    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
            ...
            let depoistPaymentGateway = [
                ...
                { 'type': 'NETBANKING', 'options': [{ 'name': 'Paytm Net Banking', 'type': 'PAYTM_ALL_IN_ONE', 'status': true, 'offer_available': false, 'show': 'b', 'icon': 'bankaccounticon', 'mode': 'NET_BANKING' },{ 'name': 'Other Wallet', 'type': 'CASH_FREE', 'status': true, 'offer_available': false, 'show': 'b', 'icon': 'cashfree', 'mode': 'NET_BANKING' }, { 'name': 'Net Banking', 'type': 'PAYUMONEY', 'status': false, 'offer_available': false, 'show': 'b', 'icon': 'payumoney', 'mode': '' }], },
