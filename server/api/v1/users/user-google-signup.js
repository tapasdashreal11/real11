    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
            ...
            let depoistPaymentGateway = [
                ...
                { 'name': 'Other Wallet', 'type': 'CASH_FREE', 'status': true, 'offer_available': false, 'show': 'a', 'icon': 'cashfree', 'mode': '' },
                ...
                { 'type': 'NETBANKING', 'options': [{ 'name': 'Paytm Net Banking', 'type': 'PAYTM_ALL_IN_ONE', 'status': true, 'offer_available': false, 'show': 'b', 'icon': 'bankaccounticon', 'mode': 'NET_BANKING' },{ 'name': 'VIEW ALL Net Banking', 'type': 'CASH_FREE', 'status': true, 'offer_available': false, 'show': 'b', 'icon': 'cashfree', 'mode': 'NET_BANKING' }, { 'name': 'Net Banking', 'type': 'PAYUMONEY', 'status': false, 'offer_available': false, 'show': 'b', 'icon': 'payumoney', 'mode': '' }], },
