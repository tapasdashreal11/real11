...
module.exports = {
    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
            ...
            let depoistPaymentGateway = [{'type':'Card','options':[{'name':'Debit Card','type':'PAYTM_ALL_IN_ONE','status':true,'offer available':false,'show':'b','icon':'debit','mode':'DEBIT_CARD'},{'name':'Credit Card','type':'PAYTM_ALL_IN_ONE','status':true,'offer available':false,'show':'b','icon':'credit','mode':'CREDIT_CARD'}]},{'type':'Wallet','options':[{'name':'Paytm','type':'PAYTM_ALL_IN_ONE','status':true,'offer available':true,'show':'b','icon':'paytm1','mode':''},{'name':'Phonepay','type':'PHONEPE','status':true,'offer available':true,'show':'a','icon':'phonepe_icon','mode':''},{'name':'Mobikwik','type':'MOBIKWICK','status':false,'offer available':false,'show':'a','icon':'mobo_icon','mode':''},{'name':'Other Wallet','type':'PAYUBIZ','status':true,'offer available':false,'show':'b','icon':'payubiz','mode':''}]},{'type':'UPI/Google Pay/BHIM','options':[{'name':'Paytm UPI','type':'PAYTM_ALL_IN_ONE','status':true,'offer available':false,'show':'b','icon':'plus','mode':'UPI_INTENT'}]},{'type':'NETBANKING','options':[{'name':'VIEW ALL Net Banking','type':'PAYTM_ALL_IN_ONE','status':true,'offer available':false,'show':'b','icon':'bankaccounticon','mode':'NET_BANKING'},{'name':'Net Banking','type':'PAYUMONEY','status':true,'offer available':false,'show':'b','icon':'payumoney','mode':''}]}];
            response["message"] = "";
