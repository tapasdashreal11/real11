...
module.exports = {
    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
            ...
            let depoistPaymentGateway = [{'type':'Card','options':[{'name':'Debit Card','type':'paytm','status':true,'offer available':false,'show':'b','icon':'debit'},{'name':'Credit Card','type':'paytm','status':true,'offer available':false,'show':'b','icon':'credit'}]},{'type':'Wallet','options':[{'name':'Paytm','type':'paytm','status':true,'offer available':true,'show':'b','icon':'paytm1'},{'name':'Phonepay','type':'phonepay','status':true,'offer available':true,'show':'a','icon':'phonepe_icon'},{'name':'Other Wallet','type':'payubiz','status':true,'offer available':false,'show':'b','icon':'payubiz'}]},{'type':'UPI/Google Pay/BHIM','options':[{'name':'Paytm UPI','type':'paytm','status':true,'offer available':false,'show':'b','icon':'plus'}]},{'type':'NETBANKING','options':[{'name':'VIEW ALL Net Banking','type':'paytm','status':true,'offer available':false,'show':'b','icon':'bankaccounticon'},{'name':'Net Banking','type':'payumoney','status':true,'offer available':false,'show':'b','icon':'payumoney'}]}];
            response["message"] = "";
