    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
           ...
           /* let depoistPaymentGateway = [
            ...
            let depoistPaymentGateway = [{'type':'Card','options':[{'name':'Debit/Credit Card','type':'CASH_FREE','status':true,'offer_available':false,'offer_comment':'','show':'b','icon':'debit','mode':'DEBIT_CARD'},{'name':'Credit Card','type':'CASH_FREE','status':false,'offer_available':false,'offer_comment':'','show':'b','icon':'credit','mode':'CREDIT_CARD'}]},{'type':'Recommendation','options':[{'name':'PhonePe/BHIM UPI','type':'PHONEPE','status':false,'offer_available':true,'offer_comment':'This is testing offer to use for deposit','show':'a','icon':'phonepe_icon','mode':''}]},{'type':'Wallet','options':[{'name':'Paytm','type':'PAYTM_ALL_IN_ONE','status':true,'offer_available':true,'offer_comment':'₹5 - ₹50 Cashback on a minimum deposit of ₹75. Valid 2 times per month. T&C Apply.','show':'b','icon':'paytm1','mode':''},{'name':'PhonePe','type':'PHONEPE','status':true,'offer_available':true,'offer_comment':'Get upto ₹500 Cashback on first 5 txn. Min txn 500. T&C Apply.','show':'a','icon':'phonepe_icon','mode':''},{'name':'Other Wallets','type':'CASH_FREE','status':true,'offer_available':false,'show':'a','icon':'plus','mode':''},{'name':'MobiKwik','type':'MOBIKWIK','status':false,'offer_available':true,'show':'a','icon':'mobikwik','mode':''},{'name':'Other Wallet','type':'PAYUBIZ','status':false,'offer_available':false,'show':'b','icon':'payubiz','mode':''}]},{'type':'UPI/Google Pay/BHIM','options':[{'name':'Paytm UPI','type':'PAYTM_ALL_IN_ONE','status':true,'offer_available':true,'offer_comment':'Get upto ₹500 Cashback on first 5 txn. Min txn 500. T&C Apply.', 'show':'b','icon':'plus','mode':'UPI_INTENT'}]},{'type':'NETBANKING','options':[{'name':'VIEW ALL Net Banking','type':'CASH_FREE','status':true,'offer_available':false,'show':'b','icon':'bankaccounticon','mode':'NET_BANKING'},{'name':'Paytm Net Banking','type':'PAYTM_ALL_IN_ONE','status':true,'offer_available':false,'offer_comment':'Get ₹30 Cashback on a minimum deposit of ₹1000 via Paytm Payments Bank Net Banking. T&C Apply.','show':'b','icon':'paytm1','mode':'NET_BANKING'},{'name':'Net Banking','type':'PAYUMONEY','status':false,'offer_available':false,'show':'b','icon':'payumoney','mode':''}],}];
            let sportTypes = [{"sport":1,"name":"Cricket","active":true,"allow":"b"},{"sport":4,"name":"Kabaddi","active":true,"allow":"b"},{"sport":3,"name":"Games","active":true,"allow":"a"},{"sport":2,"name":"Football","active":true,"allow":"b"}];
            response["message"] = "";
