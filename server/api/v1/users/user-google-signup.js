    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
            ...
            let depoistPaymentGateway = [
                ...
                { 'type': 'NETBANKING', 'options': [{ 'name': 'VIEW ALL Net Banking', 'type': 'CASH_FREE', 'status': true, 'offer_available': false, 'show': 'b', 'icon': 'bankaccounticon', 'mode': 'NET_BANKING' }, { 'name': 'Net Banking', 'type': 'PAYUMONEY', 'status': true, 'offer_available': false, 'show': 'b', 'icon': 'payumoney', 'mode': '' }], },
