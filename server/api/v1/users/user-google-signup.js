    ...
    userRefStaticData: async (req, res) => {
        ...
        try {
            ...
            let bank_change_req_txt = {
                ...
                points: [
                    { "item": "It typically takes 2 days to verify a bank account." },
           ...
           /* let depoistPaymentGateway = [
            ...
            let depoistPaymentGateway = [{'type':'Card','options':[{'name':'Debit/Credit Card','type':'CASH_FREE','status':true,'offer_available':false,'offer_comment':'','show':'b','icon':'debit','mode':'DEBIT_CARD'},{'name':'Credit Card','type':'CASH_FREE','status':false,'offer_available':false,'offer_comment':'','show':'b','icon':'credit','mode':'CREDIT_CARD'}]},{'type':'Recommendation','options':[{'name':'PhonePe/BHIM UPI','type':'PHONEPE','status':true,'offer_available':true,'offer_comment':'This is testing offer to use for deposit','show':'a','icon':'phonepe_icon','mode':''}]},{'type':'Wallet','options':[{'name':'Paytm','type':'PAYTM_ALL_IN_ONE','status':true,'offer_available':true,'offer_comment':'This is testing offer to use for deposit','show':'b','icon':'paytm1','mode':''},{'name':'PhonePe','type':'PHONEPE','status':true,'offer_available':true,'offer_comment':'This is testing offer to use for deposit','show':'a','icon':'phonepe_icon','mode':''},{'name':'Other Wallets','type':'CASH_FREE','status':true,'offer_available':false,'show':'a','icon':'plus','mode':''},{'name':'MobiKwik','type':'MOBIKWIK','status':false,'offer_available':true,'show':'a','icon':'mobikwik','mode':''},{'name':'Other Wallet','type':'PAYUBIZ','status':false,'offer_available':false,'show':'b','icon':'payubiz','mode':''}]},{'type':'UPI/Google Pay/BHIM','options':[{'name':'Paytm UPI','type':'PAYTM_ALL_IN_ONE','status':true,'offer_available':false,'show':'b','icon':'plus','mode':'UPI_INTENT'}]},{'type':'NETBANKING','options':[{'name':'VIEW ALL Net Banking','type':'CASH_FREE','status':true,'offer_available':false,'show':'b','icon':'bankaccounticon','mode':'NET_BANKING'},{'name':'Paytm Net Banking','type':'PAYTM_ALL_IN_ONE','status':true,'offer_available':false,'show':'b','icon':'paytm1','mode':'NET_BANKING'},{'name':'Net Banking','type':'PAYUMONEY','status':false,'offer_available':false,'show':'b','icon':'payumoney','mode':''}],}];
            response["message"] = "";
