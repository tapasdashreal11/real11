    ...
    try {
      ...
      try {
        ...
        if (user) {
          ...
          let level = 1;
          let totalPaidContest = userProData && userProData.paid_contest_count ? userProData.paid_contest_count : 0; //(!_.isEmpty(paidContests)) ? paidContests["0"].player_team_id : 0;
