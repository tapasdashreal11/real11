...
module.exports = {
    matchList: async (req, res) => {
        try {
            ...
            data1.sport_type = [{"sport":1,"name":"Circket","icon":"circket.png","allow":"b"},{"sport":2,"name":"Football","icon":"football.png","allow":"b"},{"sport":3,"name":"Other Game","icon":"other.png","allow":"a"}];
