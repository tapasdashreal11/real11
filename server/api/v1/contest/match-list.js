...
module.exports = {
    matchList: async (req, res) => {
        try {
           ...
           // data1.sport_type = [{"sport":1,"name":"Cricket","active":true,"allow":"b"},{"sport":2,"name":"Football","active":true,"allow":"b"},{"sport":3,"name":"Ludo","active":true,"allow":"a"},{"sport":4,"name":"Kabaddi","active":true,"allow":"b"}];
