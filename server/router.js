...
const {userGoogleSignIn,userGoogleSignUpDetailAdd,userSignup,userNormalSignUpDetailUpdate,userAvtarUpdate,userAppleSignIn} = require('./api/v1/users/user-google-signup');
