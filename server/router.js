...
const  joinContestNewOne1  = require('./api/v1/contest/join-contest-head-to-head');
const  joinContestNewOne  = require('./api/v1/contest/join-contest-head-to-head-redis');
const  joinContestMultipleTeam1  = require('./api/v1/contest/join-contest-multiple-team');
const  joinContestMultipleTeamLL  = require('./api/v1/contest/join-contest-multiple-pro');
const  joinContestMultipleTeam  = require('./api/v1/contest/join-contest-multiple-redis');
