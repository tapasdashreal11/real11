...
router.get('/api/v1/contest-list1/:match_id/:sport?', auth.authenticate.jwtLogin, redis.cacheMiddle, contestList);
//router.get('/api/v1/contest-list1/:match_id/:sport?/:series_id?', auth.authenticate.jwtLogin, redis.cacheMiddle, contestList);
