...
const {userCouponPurchase,userCouponList,userCouponWalletAmount,userCouponResume} = require('./api/v1/users/user-coupon-sale');
const {
    resetPasswordView,
    resetPassword
...
router.get('/api/v1/user-coupon-revoke', auth.authenticate.jwtLogin,userCouponResume); 
