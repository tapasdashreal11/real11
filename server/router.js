...
const {realRefCodeGenerate,verifyReferal, verifyReferalRedisEnt, verifyEmail, verifyAccountEmail ,updateUserFCMToken,verifyGmailAccount} = require('./api/v1/users/verify-email');
...
router.get('/api/v1/contest-list-new1/:match_id/:sport?/:series_id?', auth.authenticate.jwtLogin, redis.cacheMiddle, contestListNewRedisEnt);
